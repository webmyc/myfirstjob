    ...
    return (
        <div className="bg-white rounded-2xl shadow-xl p-8 max-w-2xl mx-auto border-2 border-gray-100">
            ...
            <div className="space-y-6">
                {/* Service Type */}
                <div>
                    <label className="block text-sm font-bold text-gray-700 mb-2">{t('calculator.question_service')}</label>
                ...
                <div>
                    <label className="block text-sm font-bold text-gray-700 mb-2">
                        {t('calculator.question_hours', { hours })}
                    </label>
                    <input
                        type="range"
                        min="1"
                ...
                <div className="mt-8 bg-dark text-white p-6 rounded-xl text-center relative overflow-hidden">
                    ...
                    <p className="text-gray-400 mb-2">{t('calculator.investment')}</p>
